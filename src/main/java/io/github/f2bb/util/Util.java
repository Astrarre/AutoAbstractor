...
public class Util {
	...
	//   then, when it's loaded, generate a class and use the VolatileCallSite to point to that new class that
	//   accounts for inheritance

	//   if a method is invoked that has a signature of anything other than the Struct, then they are trying to pass
